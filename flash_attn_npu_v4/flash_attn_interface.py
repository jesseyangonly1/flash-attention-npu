...
def _flash_attn_forward(
    ...
    out, softmax_lse, out_accum, softmax_lse_accum = flash_attn_npu_4.fwd(
        q,
        k,
        v,
        k_new,
...
@_torch_custom_op_wrapper("flash_attn_npu_4::_flash_attn_backward", mutates_args=("dq", "dk", "dv"), device_types="npu")
...
@_torch_register_fake_wrapper("flash_attn_npu_4::_flash_attn_backward")
...
def flash_attn_combine(out_partial, lse_partial, out=None, out_dtype=None):
    return flash_attn_npu_4.fwd_combine(out_partial, lse_partial, out, out_dtype)
