...
@_torch_custom_op_wrapper(
    "flash_attn_npu_950_4_C::_flash_attn_forward", mutates_args=(), device_types="npu"
)
def _flash_attn_forward(
    ...
    out_t, softmax_lse, out_accum, softmax_lse_accum = flash_attn_npu_950_4.fwd(
        q, k, v,
        k_new, v_new, qv,
        out,
        cu_seqlens_q, cu_seqlens_k, cu_seqlens_k_new,
...
@_torch_register_fake_wrapper("flash_attn_npu_950_4_C::_flash_attn_forward")
